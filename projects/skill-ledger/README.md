...
2. **Optionally personalize the prose** — swap "the learner" for a real name/pronouns throughout `SKILL.md` and `references/policy.md` if this is being set up for one person, one time. Not required — the pattern works fine addressed generically.
