...
| Path | What it is |
|---|---|
| [`automation-examples/grocery-price-tracking`](./automation-examples/grocery-price-tracking) | Multi-store price comparison via browser automation: per-unit normalization, cross-store value flagging, and an `/init` step for plugging in your own store list |
